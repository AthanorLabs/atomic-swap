...
// Source: github.com/athanorlabs/atomic-swap/net/swapnet (interfaces: Host)
...
func (m *MockHost) AddrInfo() peer.AddrInfo {
	m.ctrl.T.Helper()
...
func (mr *MockHostMockRecorder) AddrInfo() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddrInfo", reflect.TypeOf((*MockHost)(nil).AddrInfo))
}

// Addresses mocks base method.
func (m *MockHost) Addresses() []string {
	m.ctrl.T.Helper()
...
func (mr *MockHostMockRecorder) Addresses() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Addresses", reflect.TypeOf((*MockHost)(nil).Addresses))
}
...
func (m *MockHost) ConnectedPeers() []string {
	m.ctrl.T.Helper()
...
func (mr *MockHostMockRecorder) ConnectedPeers() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ConnectedPeers", reflect.TypeOf((*MockHost)(nil).ConnectedPeers))
}

// Discover mocks base method.
func (m *MockHost) Discover(arg0 coins.ProvidesCoin, arg1 time.Duration) ([]peer.ID, error) {
	m.ctrl.T.Helper()
...
func (m *MockHost) PeerID() peer.ID {
	m.ctrl.T.Helper()
...
func (mr *MockHostMockRecorder) PeerID() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PeerID", reflect.TypeOf((*MockHost)(nil).PeerID))
}
