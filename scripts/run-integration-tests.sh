...
./monero-bin/monerod --detach --regtest --offline --fixed-difficulty=1 --rpc-bind-port 18081 &
sleep 5

echo "starting monero-wallet-rpc on port 18083..."
mkdir bob-test-keys
./monero-bin/monero-wallet-rpc --rpc-bind-port 18083 --disable-rpc-login --wallet-dir ./bob-test-keys &> monero-wallet-cli-bob.log &
...
./monero-bin/monero-wallet-rpc --rpc-bind-port 18084 --disable-rpc-login --wallet-dir ./alice-test-keys &> monero-wallet-cli-alice.log &
